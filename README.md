...
-------------
![image](https://github.com/Xiaozhi-Wang99/PSGenerator/blob/main/Figure/GUI.jpg)
#### Screenshots and workflow of the GUI.

-------------
## Packages:
1. Python (version: 3.8.20)
2. PyTorch (version: 2.0.1)
3. Numpy (version: 1.24.3)
4. Pandas (version: 1.5.3)
5. Matplotlib (version: 3.6.2)
6. RDKit (version: 2024.3.5)
7. Scikit-learn (version: 1.3.2)
8. Xgboost (version: 1.0.2)
9. Hyperopt (version: 0.2.7)
10. Torch_geometric (version: 2.6.1)
11. Captum (version: 0.6.0)
12. PyQt5 (version 5.15.11)
