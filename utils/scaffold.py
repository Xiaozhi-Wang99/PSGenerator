...
class SlicedMol:
    def __init__(self, scaffold, decorations):
        ...
        :param decorations: Either a list or a dict with the decorations as Mol objects.wodi
        """
...
def join(scaffold_smi, decoration_smi, keep_label_on_atoms=False):
    ...
    if scaffold and decoration:
        ...
        try:
            ...
            # print(f"Sanitization failed for scaffold.\n"
            #       f"Decoration SMILES: {decoration_smi}\n", f"Scaffold SMILES: {scaffold_smi}")
            return None
    else:
        return None
